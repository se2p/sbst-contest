...
report~\cite{SBFT-toolcomp23}. \EVOSUITE achieved an overall score of \score,
...
As a general trend, participants seem to value expressive names for test cases
variables, separation of concerns (i.e., unrelated functionality is )
